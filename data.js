...
const allEngineeringSubjects = [
    { kod: "BAF1022", nama: "Bahasa Arab Praktikal", kredit: 2 },
    { kod: "BAF3022", nama: "Bahasa Arab Sains", kredit: 2 },
    { kod: "BAU2022", nama: "Bahasa Arab Komunikasi", kredit: 2 },
    { kod: "BIF4022", nama: "Bahasa Inggeris untuk Keperluan Profesional", kredit: 2 },
    { kod: "BIK1012", nama: "Bahasa Inggeris 1", kredit: 2 },
    { kod: "BIK1032", nama: "Bahasa Inggeris 3", kredit: 2 },
    { kod: "BIK2042", nama: "Bahasa Inggeris 4", kredit: 2 },
    { kod: "BIP1012", nama: "Kemahiran Am Bahasa Inggeris", kredit: 2 },
    { kod: "BIP1022", nama: "Bahasa Inggeris 2", kredit: 2 },
    { kod: "BIP2012", nama: "Bahasa Inggeris untuk Komunikasi", kredit: 2 },
    { kod: "BIU3012", nama: "Bahasa Inggeris untuk Keperluan Akademik", kredit: 2 },
    { kod: "BUA1012", nama: "Bahasa Arab Asas", kredit: 2 },
    { kod: "KEE1103", nama: "Asas Litar Elektrik I", kredit: 3 },
    { kod: "KEE1133", nama: "Teknologi Elektrik", kredit: 3 },
    { kod: "KEE1223", nama: "Rekabentuk Logik", kredit: 3 },
    { kod: "KEE1243", nama: "Peranti Elektronik Analog", kredit: 3 },
    { kod: "KEE1253", nama: "Instrumentasi dan Pengukuran", kredit: 3 },
    { kod: "KEE2303", nama: "Asas Litar Elektrik II", kredit: 3 },
    { kod: "KEE2333", nama: "Rekabentuk Litar Elektronik", kredit: 3 },
    { kod: "KEE2343", nama: "Kejuruteraan Kuasa Elektrik", kredit: 3 },
    { kod: "KEE2352", nama: "Amalan Kejuruteraan (2 Kredit)", kredit: 2 },
    { kod: "KEE2353", nama: "Amalan Kejuruteraan (3 Kredit)", kredit: 3 },
    { kod: "KEE2363", nama: "Peranti Penderia", kredit: 3 },
    { kod: "KEE2423", nama: "Teori Isyarat dan Litar", kredit: 3 },
    { kod: "KEE2433", nama: "Teori Elektromagnetik", kredit: 3 },
    { kod: "KEE2443", nama: "Mikroelektronik", kredit: 3 },
    { kod: "KEE3513", nama: "Teori Kawalan", kredit: 3 },
    { kod: "KEE3523", nama: "Mikropemproses dan Kawalan Terbenam", kredit: 3 },
    { kod: "KEE3553", nama: "Pengurusan Projek Kejuruteraan dan Kewangan", kredit: 3 },
    { kod: "KEE3604", nama: "Rekabentuk Projek Kejuruteraan", kredit: 4 },
    { kod: "KEE3612", nama: "Jurutera dan Masyarakat", kredit: 2 },
    { kod: "KEE3624", nama: "Rekabentuk Projek Kejuruteraan Elektronik", kredit: 4 },
    { kod: "KEE3633", nama: "Rekabentuk Litar Terkamir", kredit: 3 },
    { kod: "KEE3653", nama: "Robotik", kredit: 3 },
    { kod: "KEE3663", nama: "Elektronik Kuasa", kredit: 3 },
    { kod: "KEE4702", nama: "Tesis I (2 Kredit)", kredit: 2 },
    { kod: "KEE4712", nama: "Tesis I (Lama)", kredit: 2 },
    { kod: "KEE4733", nama: "Pemacu dan Mesin Elektrik", kredit: 3 },
    { kod: "KEE4753", nama: "Rekabentuk FPGA", kredit: 3 },
    { kod: "KEE4773", nama: "Peranti Semikonduktor", kredit: 3 },
    { kod: "KEE4804", nama: "Tesis II (4 Kredit)", kredit: 4 },
    { kod: "KEE4814", nama: "Tesis II (Lama)", kredit: 4 },
    { kod: "KEE4833", nama: "Elektronik Perubatan", kredit: 3 },
    { kod: "KEE4843", nama: "Elektronik Opto", kredit: 3 },
    { kod: "KEE4863", nama: "Sistem Kuasa", kredit: 3 },
    { kod: "KEH1123", nama: "Matematik Kejuruteraan I", kredit: 3 },
    { kod: "KEH1213", nama: "Matematik Kejuruteraan II", kredit: 3 },
    { kod: "KEH2323", nama: "Kaedah Berangka untuk Kejuruteraan", kredit: 3 },
    { kod: "KEH2412", nama: "Statistik Kejuruteraan", kredit: 2 },
    { kod: "KEK1113", nama: "Pengaturcaraan untuk Kejuruteraan", kredit: 3 },
    { kod: "KEK3573", nama: "Senibina dan Organisasi Komputer", kredit: 3 },
    { kod: "KEK4743", nama: "Rangkaian Neural dan Logik Fuzzy", kredit: 3 },
    { kod: "KEK4783", nama: "Kecerdasan Buatan", kredit: 3 },
    { kod: "KET3563", nama: "Komunikasi Elektronik", kredit: 3 },
    { kod: "KET3643", nama: "Pemprosesan Isyarat Digit", kredit: 3 },
    { kod: "KET4763", nama: "Komunikasi Data dan Internet", kredit: 3 },
    { kod: "KET4853", nama: "Kejuruteraan Frekuensi Radio dan Mikrogelombang", kredit: 3 },
    { kod: "KEZ3996", nama: "Latihan Industri", kredit: 6 },
    { kod: "KGE2413", nama: "Kejuruteraan Sistem Kuasa", kredit: 3 },
    { kod: "KGE3543", nama: "Mesin Elektrik", kredit: 3 },
    { kod: "KGE3613", nama: "Analisis Sistem Kuasa", kredit: 3 },
    { kod: "KGE3614", nama: "Rekabentuk Projek Kejuruteraan Elektrik", kredit: 4 },
    { kod: "KGE4712", nama: "Thesis I (Elektrik)", kredit: 2 },
    { kod: "KGE4713", nama: "Kejuruteraan Voltan Tinggi", kredit: 3 },
    { kod: "KGE4723", nama: "Pemacu Elektrik", kredit: 3 },
    { kod: "KGE4733", nama: "Perlindungan Sistem Kuasa", kredit: 3 },
    { kod: "KGE4753", nama: "Prinsip Ekonomi Elektrik", kredit: 3 },
    { kod: "KGE4813", nama: "Pembelajaran Mesin", kredit: 3 },
    { kod: "KGE4823", nama: "Pengurusan dan Penggunaan Tenaga Elektrik", kredit: 3 },
    { kod: "KGE4833", nama: "Tenaga Boleh Baharu", kredit: 3 },
    { kod: "KGE4843", nama: "Rekabentuk Pencawang", kredit: 3 },
    { kod: "KGE4853", nama: "Pengenalan Grid Pintar", kredit: 3 },
    { kod: "KGE4854", nama: "Tesis II (Elektrik)", kredit: 4 },
    { kod: "UBY1012", nama: "Bahasa Melayu Komunikasi", kredit: 2 },
    { kod: "UTC1012", nama: "Penghayatan Etika dan Peradaban", kredit: 2 },
    { kod: "UTC1022", nama: "Ethics and Civilization", kredit: 2 },
    { kod: "UTD1022", nama: "Akidah dan Tasawuf", kredit: 2 },
    { kod: "UTF1032", nama: "al-Madkhal Ila al-Fiqh al-Islami", kredit: 2 },
    { kod: "UTI1022", nama: "Al-Dirasat al-Islamiyyah I", kredit: 2 },
    { kod: "UTI1032", nama: "Al-Dirasat al-Islamiyyah II", kredit: 2 },
    { kod: "UTP1012", nama: "Falsafah dan Isu Semasa", kredit: 2 },
    { kod: "UTR1012", nama: "Integriti dan Antirasuah", kredit: 2 },
    { kod: "UTT3012", nama: "Pengantar Kitab Turath", kredit: 2 },
    { kod: "UTU3012", nama: "Keusahawanan", kredit: 2 }
];
